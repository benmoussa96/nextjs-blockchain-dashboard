    ...
    >
      <div className="flex h-full flex-col p-5">
        ...
        <div className="flex-grow">
          <div className="grid grid-cols-1 gap-6 [&_.range-field>span.mr-2]:mb-1.5 [&_.range-field]:flex-col [&_.range-field]:items-start [&_.react-datepicker-wrapper]:w-full [&_.react-datepicker-wrapper_.w-72]:w-full [&_.text-gray-500]:text-gray-700 [&_button.h-9]:h-10 sm:[&_button.h-9]:h-11 [&_label>.h-9]:h-10 sm:[&_label>.h-9]:h-11 [&_label>.w-24.h-9]:w-full">
            {children}
          </div>
        </div>
        <Button
